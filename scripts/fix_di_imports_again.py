"""
Script to fix dependency injection imports again.

This script updates imports to use the new config_factory module.
"""
import sys
import os
import re
...
def update_imports(file_path: str) -> Tuple[bool, str]:
    ...
    try:
        ...
        # Replace imports
        new_content = re.sub(
            r"from\s+src\.infrastructure\.di\.config\s+import\s+configure_container",
            "from src.infrastructure.di.config_factory import configure_container",
            content
        )
