...
class VariableFactory:
    ...
    def register_variable_class(self, var_type: VariableType, variable_class: Type[Variable]) -> None:
        ...
        Raises:
            TypeError: If the variable class doesn't inherit from BaseVariable
        """
        if not issubclass(variable_class, Variable):
            raise TypeError(f"Variable class must inherit from BaseVariable: {variable_class.__name__}")
