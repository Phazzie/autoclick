...
class Variable(IVariable[T], Generic[T]):
    ...
    def __init__(
        ...
        self._value = self._validate_and_convert_value(value, name, var_type)
    ...
    def set_value(self, new_value: T) -> None:
        ...
        converted_value = self._validate_and_convert_value(new_value, self._name, self._type)
    ...
    def _notify_change(self, old_value: Any, new_value: Any) -> None:
        ...
        Raises:
            Exception: If a listener raises an exception and error_policy is 'raise'
        """
    ...
    def _validate_and_convert_value(self, value: T, name: str, var_type: VariableType) -> T:
        """
        Validate and convert a value to the correct type if needed
