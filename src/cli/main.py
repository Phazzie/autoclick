...
def create_parser() -> argparse.ArgumentParser:
    ...
    # Screenshot command
    screenshot_parser = subparsers.add_parser("screenshot", help="Take screenshots")
    screenshot_subparsers = screenshot_parser.add_subparsers(dest="subcommand", help="Screenshot subcommand")

    # Screenshot page
    screenshot_page_parser = screenshot_subparsers.add_parser("page", help="Take a screenshot of a page")
    screenshot_page_parser.add_argument("url", help="URL to navigate to")
    screenshot_page_parser.add_argument("--name", help="Name for the screenshot (without extension)")
    screenshot_page_parser.add_argument("--output-dir", help="Directory to save the screenshot")
    screenshot_page_parser.add_argument("--browser", default="chrome", help="Browser to use")
    screenshot_page_parser.add_argument("--headless", action="store_true", help="Run in headless mode")
    screenshot_page_parser.add_argument("--timeout", type=int, default=30, help="Timeout in seconds")
    screenshot_page_parser.add_argument("--wait", type=int, help="Wait time in seconds before taking the screenshot")

    # Screenshot element
    screenshot_element_parser = screenshot_subparsers.add_parser("element", help="Take a screenshot of an element")
    screenshot_element_parser.add_argument("url", help="URL to navigate to")
    screenshot_element_parser.add_argument("selector", help="CSS selector for the element")
    screenshot_element_parser.add_argument("--name", help="Name for the screenshot (without extension)")
    screenshot_element_parser.add_argument("--output-dir", help="Directory to save the screenshot")
    screenshot_element_parser.add_argument("--browser", default="chrome", help="Browser to use")
    screenshot_element_parser.add_argument("--headless", action="store_true", help="Run in headless mode")
