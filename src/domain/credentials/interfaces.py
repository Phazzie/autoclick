...
class ICredentialReader(Protocol):
    """Interface for reading credential information."""
...
@runtime_checkable
class ICredentialWriter(Protocol):
    """Interface for writing credential information."""
...
@runtime_checkable
class ICredentialValidator(Protocol):
    """Interface for validating credentials."""
...
@runtime_checkable
class ICredentialTester(Protocol):
    """Interface for testing credentials."""
...
@runtime_checkable
class ICredentialService(ICredentialReader, ICredentialWriter, ICredentialValidator, ICredentialTester, Protocol):
    """Comprehensive interface for credential services."""
    pass
