"""
Base action adapter implementation.

This module provides a base implementation of the action adapter interface.
"""
from abc import ABC, abstractmethod
from typing import List, Dict, Any, Optional

from src.ui.adapters.interfaces.iaction_adapter import IActionAdapter


class BaseActionAdapter(IActionAdapter, ABC):
    """Base implementation of action adapter."""
