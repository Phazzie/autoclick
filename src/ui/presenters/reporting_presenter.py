...
class ReportingPresenter(BasePresenter):
    ...
    def load_reports(self):
        ...
        try:
            ...
            self.view.display_error("Error", f"Failed to load reports: {str(e)}")
    ...
    def generate_report(self, report_id: str, format_type: str):
        ...
        try:
            ...
            if not success:
                self.view.display_error("Error", f"Failed to generate report: {result}")
                return
            ...
            self.view.display_error("Error", f"Failed to generate report: {str(e)}")
    ...
    def _handle_error(self, action: str, error: Exception):
        ...
        """
        # Log the error
        print(f"Error {action}: {str(error)}")
